...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::repo_ssh::ssh_upload_file,
            commands::repo_ssh::ssh_download_file,
            ...
            commands::sched_runs::sched_runs_list,
            commands::sched_runs::sched_runs_clear,
            commands::resources::resources_status,
            ...
            commands::resources_rules::resources_matrix,
            commands::resources_rules::resources_set_rule,
            commands::resources_rules::resources_reset_rules,

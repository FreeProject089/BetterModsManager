    ...
    articles: [
      {
        ...
        body: {
          en: '<p>BMM ships <b>13 built-in themes</b> — dark ones (Default, Sombre, Void, Discord, Spotify, Nord, VS Code, macOS…) and four light ones (Full White, Brutalist, Clay, Sakura). Switch in <b>Settings → Themes</b>, or make your own.</p>'
          ...
          fr: '<p>BMM livre <b>13 thèmes intégrés</b> — des sombres (Default, Sombre, Void, Discord, Spotify, Nord, VS Code, macOS…) et quatre clairs (Full White, Brutalist, Clay, Sakura). Changez dans <b>Réglages → Thèmes</b>, ou créez le vôtre.</p>'

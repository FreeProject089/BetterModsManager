...
// â”€â”€ content model â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
type Part = 'user' | 'dev';
...
interface Article {
  ...
  diagram?: string;        // diagram registry id â†’ window.openDiagram
  docsPath?: string;       // appended to DOCS_SITE for "Read full docs"
  view?: string;           // a nav data-view â†’ "Open in BMM" button that jumps to that screen
  keywords?: string;       // extra search terms (any language, space separated)
  wide?: boolean;          // reference article: mostly lookup tables â†’ widen the column
}
...
// â”€â”€ state + host â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
function crumbs(): string {
  ...
  const partName: L = route.part === 'dev' ? { en: 'Developer', fr: 'DÃ©veloppeur' } : { en: 'User guide', fr: 'Guide utilisateur' };
...
function mediaBlock(m: Media): string {
  ...
  if (m.kind === 'replay' && m.src) return `<figure class="dh-media"><button class="dh-replay" data-replay="${m.src}">${svg('play', 20)} <span>${tr({ en: 'Play session recording', fr: 'Lire lâ€™enregistrement' })}</span></button>${cap}</figure>`;
  return '';
}

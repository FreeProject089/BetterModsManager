...
La référence complète champ par champ, avec chaque clé optionnelle et un tableau de diagnostic, est sur le site de documentation.`,
      ...
      },
      {
        ...
        summary: { en: 'A real automation builder — triggers, conditions, loops and 95 actions.', fr: 'Un vrai constructeur d’automatisations — déclencheurs, conditions, boucles et 95 actions.' },

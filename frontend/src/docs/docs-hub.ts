...
Automatise-le depuis le [Planificateur](doc:scheduler) : benchmarke un disque, applique une limite, ou vérifie l’espace libre et branche sur le résultat.`,
  ...
  },
  {
    ...
    articles: [
      ...
      devArticle('betahub-reporting', { en: 'Feedback & crash reports', fr: 'Retours & rapports de plantage' }, { en: 'Where Settings → Feedback & bug reports sends things.', fr: 'Où partent les envois de Réglages → Retours & rapports de bug.' }, 'feedback bug crash report betahub bettercommunity', {

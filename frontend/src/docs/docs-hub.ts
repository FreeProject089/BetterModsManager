  ...
  },
  {
    ...
    articles: [
      ...
      },
      {
        ...
        keywords: 'ssh sftp publish upload download pull fetch sync mirror password key ppk openssh fingerprint scp winscp filezilla browse remote folder publier envoyer r\u00e9cup\u00e9rer t\u00e9l\u00e9charger synchroniser mot de passe cl\u00e9 empreinte t\u00e9l\u00e9verser parcourir dossier distant',
        body: {
          ...
          fr: '<p>L\u2019export \u00e9crit un dossier. <b>Publier par SSH</b>, sur le m\u00eame \u00e9cran, est ce qui d\u00e9pose ce dossier sur la machine qui l\u2019h\u00e9berge \u2014 sans programme de transfert s\u00e9par\u00e9, et sans envoi \u00e0 moiti\u00e9 termin\u00e9 que personne ne remarque.</p>'
            ...
            + '<h4>Sans ouvrir l\u2019\u00e9cran</h4><p>Le planificateur propose <b>Publier le d\u00e9p\u00f4t par SSH</b> et <b>R\u00e9cup\u00e9rer le d\u00e9p\u00f4t par SSH</b> ; les liens profonds sont <code>bmm://repo/publish-ssh?dir=&lt;dossier&gt;</code> et <code>bmm://repo/sync-ssh?dir=&lt;dossier&gt;</code> ; l\u2019API expose <code>POST /api/repo/publish-ssh</code> et <code>POST /api/repo/sync-ssh</code>. Tous utilisent la cible enregistr\u00e9e ici \u2014 aucun ne peut d\u00e9signer un autre h\u00f4te, une autre cl\u00e9 ni un mot de passe. Cela compte surtout pour la r\u00e9cup\u00e9ration, qui \u00e9crit sur votre propre disque : un lien capable de nommer un h\u00f4te pourrait tirer des fichiers d\u2019une machine de son choix vers un dossier de son choix.</p>'

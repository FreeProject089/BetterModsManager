...
const _indivSnapshots = new Map<string, boolean>();
 ...
 */
export function registerSingleModOp(modId: string, prevEnabled: boolean) {
 ...
 */
export function unregisterSingleModOp(modId: string) {
...
function _setCancelBtnVisible(active: boolean) {

...
!!! info ""
    ...
    85 actions · 30 conditions · 21 valeurs · 8 sources de boucle
...
| `app.stop` | Arrête un programme en cours, par nom ou par identifiant de processus. Nécessite la permission « Arrêter des programmes ». | `name` · `pid` |
